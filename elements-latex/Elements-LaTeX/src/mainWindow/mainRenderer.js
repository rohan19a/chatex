...
window.addEventListener("DOMContentLoaded", () => {
    ...
    const el = {
        ...
        enableChatGPTBtn: document.getElementById("enableChatGPTBtn"),
        toggleDropdownBtn: document.getElementById("toggleDropdownBtn"),
    };
    ...
    el.enableChatGPTBtn.addEventListener("click", () => {
        //TODO: implement this
    });

    el.toggleDropdownBtn.addEventListener("click", () => {
        //toggleDropdown();
    });
